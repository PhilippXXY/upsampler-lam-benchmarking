"""IMDN upsampling followed by LAM inference."""
...
class IMDNLAM(nn.Module):
    ...
    feature_channels : int, optional
        Number of channels in the IMDN feature extraction block (default: 64).
    mapping_channels : int, optional
        Number of channels in the IMDN mapping block (default: 32).
    loss_name : str, optional
        Reconstruction loss used by the wrapped IMDN upsampler (default: "l1").
