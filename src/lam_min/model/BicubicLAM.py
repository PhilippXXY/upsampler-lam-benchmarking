"""
Bicubic + LAM pipeline model.

This module combines the non-trainable Bicubic upsampler baseline with LAM
for end-to-end DoA inference on low-channel CSM input.
"""
...
class BicubicLAM(nn.Module):
    """
    Bicubic upsampling followed by LAM inference.
    ...
    def __init__(
        ...
        super().__init__()
        self.upsampler = BicubicUpsampler(in_channels=in_channels, out_channels=out_channels)
